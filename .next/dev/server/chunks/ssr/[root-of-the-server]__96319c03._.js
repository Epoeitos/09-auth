...
async function fetchFilterNotes(tag, page, search) {
    if (tag === 'all' && !search) {
        const res = await __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$axios$2f$lib$2f$axios$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["default"].get(`https://notehub-public.goit.study/api/notes?&page=${page}&perPage=12`, {
            headers: {
    ...
    if (tag !== 'all' && !search) {
        const res = await __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$axios$2f$lib$2f$axios$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["default"].get(`https://notehub-public.goit.study/api/notes?tag=${tag}&page=${page}&perPage=12`, {
            headers: {
                Authorization: `Bearer ${token}`
            }
        });
    ...
    if (tag === 'all' && search) {
        const res = await __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$axios$2f$lib$2f$axios$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["default"].get(`https://notehub-public.goit.study/api/notes?search=${search}&page=${page}&perPage=12`, {
            headers: {
                Authorization: `Bearer ${token}`
            }
        });
    ...
    const res = await __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$axios$2f$lib$2f$axios$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["default"].get(`https://notehub-public.goit.study/api/notes?search=${search}&tag=${tag}&page=${page}&perPage=12`, {
        headers: {
            Authorization: `Bearer ${token}`
        }
    });
...
async function createNote(note) {
    const res = await __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$axios$2f$lib$2f$axios$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["default"].post(`https://notehub-public.goit.study/api/notes`, note, {
        headers: {
            Authorization: `Bearer ${token}`
        }
    });
...
async function deleteNote(id) {
    const res = await __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$axios$2f$lib$2f$axios$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["default"].delete(`https://notehub-public.goit.study/api/notes/${id}`, {
        headers: {
            Authorization: `Bearer ${token}`
        }
    });
...
"[project]/app/notes/filter/[...slug]/page.module.css [app-rsc] (css module)", ((__turbopack_context__) => {
...
var __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$notes$2f$filter$2f5b2e2e2e$slug$5d2f$page$2e$module$2e$css__$5b$app$2d$rsc$5d$__$28$css__module$29$__ = __turbopack_context__.i("[project]/app/notes/filter/[...slug]/page.module.css [app-rsc] (css module)");
;
;
;
;
...
async function Notes({ params }) {
    ...
    await queryClient.prefetchQuery({
        ...
        queryFn: ()=>(0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["fetchFilterNotes"])(tag, 1, '')
    });
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$rsc$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["jsxDEV"])("main", {
        className: __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$notes$2f$filter$2f5b2e2e2e$slug$5d2f$page$2e$module$2e$css__$5b$app$2d$rsc$5d$__$28$css__module$29$__["default"].main,
...
//# sourceMappingURL=%5Broot-of-the-server%5D__96319c03._.js.map